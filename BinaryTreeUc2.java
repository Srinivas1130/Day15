...
public class BinaryTreeUc2 {
	...
	public static void main(String[] args) {
		BinaryTreeUc2 binaryTreeUc2 = new BinaryTreeUc2();
		binaryTreeUc2.CreatBinaryTrees();
		binaryTreeUc2.preorder(binaryTreeUc2.root);
		binaryTreeUc2.size(binaryTreeUc2.root);
	}
}
